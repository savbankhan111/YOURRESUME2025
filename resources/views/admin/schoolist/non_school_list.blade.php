...
@section('page_title','List of Non School/College')
@section('content')
                                  ...
                                  <table  class="table table-striped table-bordered">
                                     ...
                                     @forelse($candidates as $cand)
                                         ...
                                         <tr>
                                             ...
                                             <td>
											 <a class="btn btntheme" href="{{url('/admin/users-list/non-student?school='.$cand->id)}}">Students</a>
											 <a class="btn btntheme" href="{{route("admin.nonSchoolDetails", $cand->id)}}">Details</a>											 
											  <a class="btn btntheme" href="{{route("admin.editNonSchool", $cand->id)}}">Edit</a>
											 </td>
