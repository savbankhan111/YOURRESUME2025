        ...
        <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown profile-menu">
                    ...
                    <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{Auth::user()->name}}<img src="{{asset('public/images/'.Auth::user()->image)}}" alt="user" class="rounded-circle" width="31"></a>
                    <div class="dropdown-menu dropdown-menu-right user-dd animated">
                        <a class="dropdown-item profile-page" href="{{route("admin.profile")}}"><i class="ti-user m-r-5 m-l-5"></i> My Profile</a>
                        <div class="dropdown-divider"></div>

                        <form id="logout-form" action="{{ 'App\Admin' == Auth::getProvider()->getModel() ? url("/logout") : route('logout') }}" method="POST" style="display: none;">
                            {{ csrf_field() }}
                        </form>
                        <a class="dropdown-item" href="{{url('/admin/logout')}}"
                           onclick=""><i class="fa fa-power-off m-r-5 m-l-5"></i>
                           Logout</a>
