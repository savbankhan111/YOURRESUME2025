...
<link rel="icon" type="image/png" href="{{ asset('images/fev.png')}}"/>
    ...
    #frame {
     ...
     #frame .content .messages ul li.sent span.nameperson{    display: block;
    text-align: left;
    font-size: 12px;
    margin-bottom: 3px;
    position: relative;
    left: 4px;}
#frame .content .messages ul li.replies span.nameperson{  display: block;
    text-align: right;
    font-size: 12px;
    margin-bottom: 3px; 
    position: relative;
    ...
    #frame .content .messages {
        height: auto;
        min-height: calc(93% - 93px);
        max-height: calc(93% - 93px);
        overflow-y: scroll;
        overflow-x: hidden;width:100%;
    }
        #frame .content .messages  ul{clear:both;position:relative;}
            #frame .content .messages  ul:after{clear:both;content:'';display:table;}
    @media screen and (max-width: 735px) {
        #frame .content .messages {
    ...
    #frame .content .messages::-webkit-scrollbar-thumb {
      ...
      #frame .content .messages ul  {padding:-left:0px;}
...
<script>
    ...
    $(document).ready(function() {
       ...
       /* $("#searchjob").keyup(function (event) {
            event.preventDefault();
            let searchdata = $("#searchjob").val();
            let field_name ;
            let field_value;
            if(searchdata.includes("+")){
                field_name = "mob";
            }else if(Number.isInteger(parseInt(searchdata))){
                field_name = "job_id";
            }else{
                field_name = "name";
            }
