...
<link rel="icon" type="image/png" href="{{ asset('images/fev.png')}}"/>
    ...
    <link href="{{ asset('public/css/bootstrap-slider.min.css') }}" rel="stylesheet">
    <link href="{{ asset('public/css/jquery.simple-dtpicker.css') }}" rel="stylesheet">
    ...
    <script src="{{ asset('public/js/jquery.simple-dtpicker.js')}}"></script>
