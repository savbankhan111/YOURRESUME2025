                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-md-3">
												<div class="form-group">
													...
													<select id="type_of_degree" name="type_of_degree" class="form-control fsubmit">
											...
											<div class="col-md-3">
												<div class="form-group">
													...
													<select id="years_of_experience" name="years_of_experience" class="form-control fsubmit">
														<option value="">All</option>
											...
											<div class="col-md-3">
												<div class="form-group">
													<label for="">Gpa</label>
													<select id="gpa_range" name="gpa_range" class="form-control fsubmit">
														<option value="">All</option>
														@foreach(config("constants.gpa") as $gpa)
														<option value="{{$gpa}}" @if($gpa == Request::get('gpa_range')) selected @endif >{{$gpa}}</option>
														@endforeach
													</select>
												</div>
											</div>
											...
											<div class="col-md-3">
												<div class="form-group">
													...
													<select id="intership_co_op_exp" name="intership_co_op_exp" class="form-control fsubmit">
														<option value="">All</option>
											...
											<div class="col-md-3">
												<div class="form-group">
													...
													<select id="residency" name="residency" class="form-control fsubmit">
														<option value="">All</option>
											...
											<div class="col-md-3">
												<div class="form-group">
													...
													<select id="position_held" name="position_held" class="form-control fsubmit">
														<option value="">All</option>
											...
											<div class="col-md-3">
												<div class="form-group">
													...
													<select id="professional_licenses" name="professional_licenses" class="form-control fsubmit">
														<option value="">All</option>
											...
											<div class="col-md-3">
												<div class="form-group">
													...
													<select id="certifications" name="certifications" class="form-control fsubmit">
														<option value="">All</option>
											...
											<div class="col-md-3">
												<div class="form-group">
													...
													<select id="skills" name="skills" class="form-control fsubmit">
														<option value="">All</option>
                            			...
                            			<div class="row">
                            				<div class="col-md-2">
                            					<div class="profile-pic">
													...
													@else
														<img src="{{asset("images/imgperson.png")}}" class="figure-img img-fluid rounded" alt=".">
													@endif
                            					</div>
                            				</div>
                            				<div class="col-md-10">
