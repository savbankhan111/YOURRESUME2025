...
<form method="POST" action="{{ route('updateMyProfile')}}" class="form-horizontal m-t-20" enctype="multipart/form-data">
...
<div class="col-md-12">
	...
	<div class="col-md-12">
                                  <div class="form-group">
									  ...
									  @if(!empty($user->image))
									  <img src="{{ asset('public/images/'.$user->image)}}" alt="user" class="rounded-circle" width="31">
								  @endif
                                  </div>
                                </div>
